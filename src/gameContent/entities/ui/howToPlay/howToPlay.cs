...
class HowToPlay : Entity {
    ...
    public override void Draw() {
        ...
        renderer.DrawStringTo(LayerType.UI, font, "- Hopefully you destroy the base", new Vector2(offsetX, offsetY * 3.5f), Color.White, 0, Vector2.Zero, 12, SpriteEffects.None, 0);
        ...
        renderer.DrawStringTo(LayerType.UI, font, "Press [Escape] to go back to the main menu", new Vector2(offsetX, offsetY * 12f), Color.White, 0, Vector2.Zero, 12, SpriteEffects.None, 0);
        base.Draw();
    }
}